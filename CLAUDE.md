...
next:
  ...
  - แก้ receipt_pdf_v2.html บรรทัด 258 และ 292 จาก receipt.created_by.department.name เป็น receipt.department.name (ตอนนี้ render เป็นค่าว่าง หัวกระดาษ PDF v2 กับช่อง "ได้รับเงินจาก" หายไป — ห้ามแก้ด้วยการตัด .name ออกเฉย ๆ จะกลายเป็นดึงหน่วยงานสดของคนสร้าง)
