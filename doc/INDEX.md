...
### Runbook — เปิดตอนระบบมีปัญหา

| เอกสาร | ใช้เมื่อ |
|---|---|
| `doc/runbook-mysql-host-blocked.md` | ต่อ MySQL prod จากข้างนอกไม่ได้ ขึ้น `ERROR 1129 Host is blocked` — มีทั้งวิธีปลดล็อก ประเมินความเสี่ยง แผนย้อนกลับ และรายละเอียดระบบสำรองฐานข้อมูล |
...
| 2026-08-13 | `doc/progress-2026-08-13.md` — **เช้า**: รื้อเอกสารทั้งโปรเจกต์, สร้าง MEM.md, สำรวจ prod จริง · **บ่าย**: แก้ MySQL บล็อก host (ดู `runbook-mysql-host-blocked.md`), เปิด SSH, ตั้ง backup อัตโนมัติ, ส่งฟีเจอร์ปุ่ม re-sync ข้อมูล NPU ขึ้น production |
